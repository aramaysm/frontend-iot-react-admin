...
var Square_Hill_Matrix = /** @class */ (function () {
  ...
  */
    ...
    Square_Hill_Matrix.prototype.PowerOf = function (mat, power) {
        var matPower = new Square_Hill_Matrix(8, []);
    ...
    Square_Hill_Matrix.TwoPowerOf = function (power1, power2, matrix) {
        var matricesToReturn = {};
        var menorPower = 0;
        var matPowerMenor = new Square_Hill_Matrix(8, []);
        var matPowerMayor = new Square_Hill_Matrix(8, []);
...
var square1 = new Square_Hill_Matrix(8, [
...
var square2 = Square_Hill_Matrix.MultiplyHillMatrices(square1, square1);
var square3 = Square_Hill_Matrix.MultiplyHillMatrices(square2, square1);
var square4 = Square_Hill_Matrix.MultiplyHillMatrices(square3, square1);
console.log("Result power matrix is: ", Transform_Data_1["default"].Get_Array_From_SquareMatrix(square4));
/*
let matrix1: Array<Modular_Data> = square1.InitializeAs(3, 8);
square1._matrix = matrix1;
